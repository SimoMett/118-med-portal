...
%%
    ...
    \begin{figure}
        \centering
        \includesvg[width=5in]{diagrams/svg/mockup-controlcenter}
        \caption{Interfaccia applicativo della centrale}
        \label{fig:mockup-controlcenter}
    \end{figure}
    \begin{figure}
        \centering
        \includesvg[width=4in]{diagrams/svg/mockup-soccorritore}
        \caption{Interfaccia applicativo della squadra}
        \label{fig:mockup-soccorritore}
    \end{figure}
    \begin{figure}
        \centering
        \includesvg[width=4in]{diagrams/svg/mockup-autista}
    ...
    \end{figure}
    In questo package (figura \ref{fig:uml-controlcenter}) sono presenti $RescueTeamController$ e $MissionController$. Il primo $controller$ fornisce metodi di gestione delle squadre di soccorso sul territorio,
    ...
    \begin{figure}
        ...
        \label{fig:uml-ems}
    \end{figure}
    Questo package, riportato in figura \ref{fig:uml-ems}, è sicuramente quello più articolato di tutti poichè prevede un gran numero di possibili interazioni.
    ...
    \end{figure}
    Nel $DomainModel$ in figura \ref{fig:uml-ems-domainmodel} ci sono le classi $Session$ e $VehiclesList$ ed è suddiviso nei subpackage $RescueTeam$ e $Mission$.
    ...
    %\subsection{ControlCenter}
    %\subsubsection{MissionController}
    %\subsubsection{RescueTeamController}
    %\subsection{Ems}
