...
%%
    ...
    \begin{figure}
        \centering
        \includesvg[width=4.5in]{diagrams/svg/mockup-soccorritore}
        \caption{Interfaccia applicativo della squadra}
        \label{fig:mockup-soccorritore}
    \end{figure}
    \begin{figure}
        \centering
        \includesvg[width=2.5in]{diagrams/svg/mockup-autista}
    ...
    \end{figure}
    Nel $DomainModel$ in figura \ref{fig:uml-ems-domainmodel} ci sono le classi $Session$ e $VehiclesList$ ed è suddiviso nei package $RescueTeam$ e $Mission$.
