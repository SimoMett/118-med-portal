...
\begin{document}
    ...
    \begin{figure}
        ...
        \includegraphics[width=6.3in]{diagrams/png/uc-soccorritore.png}
    ...
    \begin{figure}
        ...
        \includegraphics[width=4.3in]{diagrams/png/uc-associazione.png}
    ...
    Infatti la fase di test avviene utilizzando delle $mock-implementation$ che emulano l'accesso ai dati.
