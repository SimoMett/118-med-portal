...
% TODO templates dell'autista una volta definiti
    ...
    \begin{figure}
        \centering
        \includesvg[width=6in]{uml-controlcenter.svg}
    ...
    \begin{figure}
        \centering
        \includesvg[width=6in]{uml-ems.svg}
    ...
    \begin{figure}
        \centering
        \includesvg[width=6in]{uml-organization.svg}
    ...
    \begin{figure}
        \centering
        \includesvg[width=5.4in]{uml-ems-domainmodel.svg}
